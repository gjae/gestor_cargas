...
<input type="hidden" id="modulo" value="publicaciones">
<input type="hidden" id="programa" value="publicaciones">
	    ...
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	           	<div class="modal-header">
	                <h4 class="modal-title" id="largeModalLabel">Gestion de publicaciones</h4>
	            </div>
